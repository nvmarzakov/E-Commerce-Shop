...
SECRET_KEY = 'django-insecure-ui58jd4j%*!6-nclaj*ydorx=nv%izgwbku8&+watxb$6$9($x'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'e_commerce_shop.basket_app.context_processor.basket',
            ],
        },
    },
]
